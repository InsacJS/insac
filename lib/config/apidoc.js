...
/** @ignore */ const Apidoc    = require('apidoc-creator').Apidoc
...
*/
module.exports = (app) => {
  const INFO_PATH = path.resolve(process.cwd(), 'apidoc/INFO.md')
...
* @param {!String} url    - Dirección URL del servicio.
* @return {String}
*/
...
/**
* Optimiza la propiedad query para realizar consultas sobre una lista de registros.
* @param {!Object}         QUERY   - Objeto que contiene la consulta.
