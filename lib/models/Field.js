...
class Field {
  ...
  */
  ...
  update(options = {}) {
    if (typeof options.allowNull != 'undefined') { this.allowNull = options.allowNull }
    if (typeof options.description != 'undefined') { this.description = options.description }
    if (typeof options.defaultValue != 'undefined') { this.defaultValue = options.defaultValue }
  }
  ...
  */
  ...
  static AUTHORIZATION() {
    return new Field('authorization', {
