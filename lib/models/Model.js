  ...
  constructor(name, model = {}) {
    ...
    */
    ...
    for (let fieldName in model.fields) {
      ...
      // Se adiciona un validador, si no lo tuviera
      if (!this.fields[fieldName].validator) {
        this.fields[fieldName].validator = this.fields[fieldName].type.validator()
      }
  ...
  */
  ...
  getModelOfProperty(property, models) {
    ...
    for (let i in this.fields) {
      ...
      if (field instanceof Reference) {
        let model = field.getModelOfProperty(property, models)
        if (model) {
          return model
        }
      }
