  ...
  */
  ...
  error(err) {
    ...
    if (err.name == 'SequelizeForeignKeyConstraintError') {
      ...
      if (err.original.message.startsWith('update or delete')) {
        message = `No se puede eliminar el registro '${err.original.table}', porque esta asociado con otro registro.`
      }
      if (err.original.message.startsWith('insert or update')) {
        message = `No se puede crear o actualizar el registro '${err.original.table}', porque el registro al que intenta referenciar no existe.`
      }
