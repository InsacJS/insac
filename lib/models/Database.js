        ...
        if (typeof field.reference != 'undefined') {
          switch (field.reference.type) {
            case Reference.ONE_TO_ONE:
              this.seqModels[field.reference.model].hasOne(this.seqModels[model.name], {foreignKey: model.getPK().name})
              this.seqModels[model.name].belongsTo(this.seqModels[field.reference.model], {foreignKey: field.name})
              break
            case Reference.ONE_TO_MANY:
              this.seqModels[field.reference.model].hasMany(this.seqModels[model.name], {foreignKey: model.getPK().name})
              this.seqModels[model.name].belongsTo(this.seqModels[field.reference.model], {foreignKey: field.name})
              break
            default:
