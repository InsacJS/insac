...
/** @ignore */ const Route = require('./models/Route')
      ...
      if (field instanceof Reference) {
        ...
        switch (field.reference.type) {
          case '1:1':
            ...
            this.database.models[nameA].hasOne(this.database.models[nameB], {as:model.options.singular, foreignKey: field.name})
            this.database.models[nameB].belongsTo(this.database.models[nameA], {as:this.models[nameA].options.singular, foreignKey: field.name})
            break
          case '1:N':
            this.models[nameA].options.associations.push({model:nameB, as:model.options.plural})
            this.database.models[nameA].hasMany(this.database.models[nameB], {as:model.options.plural, foreignKey: field.name})
            this.database.models[nameB].belongsTo(this.database.models[nameA], {as:this.models[nameA].options.singular, foreignKey: field.name})
            break
          default:
