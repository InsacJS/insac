    ...
    if (obj.fields) {
      for (let i in obj.fields) {
        ...
        if (typeof objField == 'string') {
          ...
          fields[fieldName] = new Field(fieldName, fieldType, true, false, fieldvalidators, false, false, false);
          continue;
        }
        ...
        fields[fieldName] = new Field(fieldName, fieldType, fieldAllowNull, fieldUnique, fieldvalidators, fieldUpperCase, fieldLowerCase, fieldPrimaryKey);
      }
    }
