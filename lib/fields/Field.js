...
class Field {
  ...
  */
  constructor(properties = {}) {
    ...
    * @type {Boolean}
    */
    this.required = (typeof properties.required != 'undefined') ? properties.required : false
  ...
  */
  update(properties = {}) {
    ...
    if (typeof properties.required != 'undefined') { this.required = properties.required }
  ...
  */
  sequelize() {
    ...
    if (typeof this.required != 'undefined') attribute.allowNull = !this.required
  ...
  */
  apidocProp(prop) {
    ...
    return (!this.required) ? `[${prop}]` : prop
  }
