...
/** @ignore */ const Field = require('../tools/Field')
...
class Apidoc {
  ...
  */
  _successMiddleware (route) {
    ...
    return Response.success({ successFormat: Response.successFormat, onSuccess })
  }
  ...
  _optionsMiddleware (route) {
    ...
    function createOptions (req) {
      if (IS_LIST) {
        ...
        const PAGE       = req.query.page  || (Field.PAGE  ? Field.PAGE.defaultValue  : 1)
