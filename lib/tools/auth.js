...
* @return {String}
*/
exports.encodeToken = (data, privateKey, exp = 86400, algorithm = 'RS256') => {
  let tokenId  = uuid()
  ...
  let payload  = {
    ...
    exp  : expire,    // Expire: Tiempo en segundos en que el token expirará
    data : data       // Data: Datos del token
  }
...
* @return {Object}
* @throws {InvalidToken|BadRequest}
*/
