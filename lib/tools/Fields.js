...
class Fields {
  ...
  */
  ...
  /**
  * Devuelve una instancia de la clase Field que representa un campo de tipo BOOLEAN.
  * @param {Object} [properties] Propiedades del campo.
  * @return {Field}
  */
  static BOOLEAN(properties = {}) {
    properties.type = DataTypes.BOOLEAN()
    return new Field(properties)
  }
  ...
  */
  ...
  /**
  * Devuelve una instancia de la clase Field que representa un campo de tipo DATETIME.
  * @param {Object} [properties] Propiedades del campo.
  * @return {Field}
  */
  static DATETIME(properties = {}) {
    properties.type = DataTypes.DATETIME()
    return new Field(properties)
  }
  ...
  */
  ...
  /**
  * Devuelve una instancia de la clase Field que representa a un campo de tipo ENUM de un modelo.
  ...
  */
  static ENUM(values, properties = {}) {
    let field = new Field({
      ...
      validator: Validators.ENUM(values),
      example: values[0]
    })
    field.update(properties)
    return field
  ...
  /**
  * Devuelve una instancia de la clase Reference que representa una referencia.
  * @param {Object} [properties={}] Propiedades del campo y de la referencia.
  * @return {Reference}
  */
  static REFERENCE(properties = {}) {
    return new Reference(properties, properties.reference, properties.association)
  }
}
